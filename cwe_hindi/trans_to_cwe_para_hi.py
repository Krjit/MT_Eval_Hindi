...
INPUT_FILE = "cwe_paraphrase_sample_pairs_en.txt"  # Tab-separated English pairs
OUTPUT_FILE = "cwe_paraphrase_sample_pairs_hi.txt"
CHECKPOINT_FILE = "ckpt_ph_hi.txt"
LOG_FILE = "trans_ph_hi.log"
